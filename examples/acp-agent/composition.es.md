...
# Composición de la app de automatización ACP

[English](composition.md) | Español

La demo ACP expone sesiones de agent nuevas con prompt de referencia (baseline) a clientes programáticos sobre JSON-RPC por stdio, sin logger de stdout, sin UI humana y sin agent precreado.
...
Configuración fuente: [`examples/acp-agent/cordis.yml`](cordis.yml).
