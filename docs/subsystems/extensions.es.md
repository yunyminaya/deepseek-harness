...
[English](extensions.md) | Español

El subsistema de extensiones permite a un agent definir paquetes Cordis con versiones, ejecutar su mitad host y su mitad de navegador, y consultar metadatos de tiempo de ejecución aprobados antes de escribir código. El ciclo de vida de los paquetes y el comportamiento del sandbox pertenecen al grupo de paquetes [`packages/extensions`](../../packages/extensions/README.es.md).
