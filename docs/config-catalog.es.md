<!-- Generado por scripts/gen-config-catalog.ts — no editar a mano.
     Ejecuta `pnpm run gen-config-catalog` para regenerar. -->

# Catálogo de configuración de plugins
[English](config-catalog.md) | Español

Cada bloque `config:` que puede fijar una entrada de `cordis.yml`: para cada paquete del harness cargable, la declaración de configuración literal (JSDoc incluido) que recibe su función `apply` o el constructor de su servicio, con cada tipo referenciado pegado junto a ella (tipos locales del paquete) o enlazado (todo lo demás). La pegada es el tipo de configuración completo que declara el plugin: un campo que el schema del runtime excluye deliberadamente es un seam exclusivo del runtime (su propio JSDoc lo dice) y no se puede fijar desde `cordis.yml`. Esta es la referencia del eje de **despliegue**: el cableado contra el que trabaja el autor de un plugin es la región generada de la API de Cordis en cada [página de subsistema](subsystems/core.es.md), los schemas de herramientas orientados al modelo son el [catálogo de herramientas](tool-catalog.es.md), y [subsistemas/](subsystems/core.es.md) documenta los tipos a los que referencian estas declaraciones.

Este archivo está GENERADO a partir del código fuente (`scripts/gen-config-catalog.ts`) y su frescura se verifica con `pnpm run verify-config-catalog` (parte de `doc-sync`): no lo edites a mano. Los bloques de declaración usan un cercado `ts config-catalog` (que doc-typecheck se salta, porque una declaración aislada que referencia imports no es compilable por sí sola). El generador también contrasta el schema schemastery del runtime contra la declaración pegada: toda clave validada por el schema, incluidas las anidadas, debe poder localizarse en el tipo de configuración declarado, de modo que la pegada no puede ocultar un campo que el loader acepte.

Una línea `Requiere:` lista las claves de servicio que el plugin inyecta con `inject`: su árbol de `cordis.yml` también debe cargar los providers de esos servicios. El ámbito es la capa del harness (`packages/`); los plugins cordis vendored que un árbol de configuración también puede cargar (`hmr`, el logger de consola, …) están fijados al código fuente upstream ([política de vendoring](../vendor/README.md)) y no se catalogan aquí.
...
Depende de: `Stream` (`@agentclientprotocol/sdk`)

Fuente: [`packages/acp/acp/src/index.ts:71`](../packages/acp/acp/src/index.ts)
...
Depende de: [`agentCore`](../packages/examples/agent-spine-demo/src/index.ts) · [`JsonlCompression`](../packages/session/session-persistence-jsonl/src/index.ts) · [`ToolsConfig`](#deepseek-aidsh-tools)

Fuente: [`packages/examples/acp-demo/src/index.ts:39`](../packages/examples/acp-demo/src/index.ts)
...
Fuente: [`packages/core/agent-default-model/src/index.ts:41`](../packages/core/agent-default-model/src/index.ts)
...
Fuente: [`packages/context/agent-instructions/src/config.ts:18`](../packages/context/agent-instructions/src/config.ts)

<a id="deepseek-aidsh-agent-loop"></a>

## `@deepseek-ai/dsh-agent-loop`

Requiere: `agents` · `sessions` · `llm` · `tools` · `systemPrompt`
...
Depende de: [`AgentOptions`](subsystems/core.es.md) · [`SessionId`](subsystems/core.es.md)

Fuente: [`packages/core/agent-loop/src/index.ts:255`](../packages/core/agent-loop/src/index.ts)
...
Fuente: [`packages/preset/agent-presets/src/preset.ts:52`](../packages/preset/agent-presets/src/preset.ts)
...
Depende de: [`ToolPresentationMode`](subsystems/tools.es.md)

Fuente: [`packages/core/agent-tool-presentation/src/index.ts:38`](../packages/core/agent-tool-presentation/src/index.ts)
...
Fuente: [`packages/attachment/attachment-local/src/index.ts:51`](../packages/attachment/attachment-local/src/index.ts)
...
Fuente: [`packages/shell/bash-local/src/index.ts:41`](../packages/shell/bash-local/src/index.ts)

<a id="deepseek-aidsh-bash-sandbox"></a>

## `@deepseek-ai/dsh-bash-sandbox`

Requiere: `subprocess` · `sandbox` · `sandboxPolicy`
...
Depende de: [`LocalConfig`](#deepseek-aidsh-bash-local)

Fuente: [`packages/shell/bash-sandbox/src/index.ts:35`](../packages/shell/bash-sandbox/src/index.ts)
...
Fuente: [`packages/client/connection/src/index.ts:50`](../packages/client/connection/src/index.ts)

<a id="deepseek-aidsh-client-hmr"></a>

## `@deepseek-ai/dsh-client-hmr`

Requiere: `clientModules` · `webServer`
...
Fuente: [`packages/client/hmr/src/index.ts:31`](../packages/client/hmr/src/index.ts)
...
Fuente: [`packages/code-runtime/code-runtime-worker-thread/src/index.ts:25`](../packages/code-runtime/code-runtime-worker-thread/src/index.ts)

<a id="deepseek-aidsh-compaction-basic"></a>

## `@deepseek-ai/dsh-compaction-basic`

Requiere: `llm` · `tokenMeter` · `sessions`
...
Fuente: [`packages/compaction/compaction-basic/src/types.ts:38`](../packages/compaction/compaction-basic/src/types.ts)
...
Fuente: [`packages/compaction/compaction-tool-result-pruner/src/types.ts:4`](../packages/compaction/compaction-tool-result-pruner/src/types.ts)
...
Fuente: [`packages/extensions/cordis-host-runner/src/index.ts:88`](../packages/extensions/cordis-host-runner/src/index.ts)
...
Fuente: [`packages/credentials/credentials-local/src/index.ts:64`](../packages/credentials/credentials-local/src/index.ts)
...
Fuente: [`packages/e2b/e2b/src/index.ts:43`](../packages/e2b/e2b/src/index.ts)

<a id="deepseek-aidsh-experimental-agent-team"></a>

## `@deepseek-ai/dsh-experimental-agent-team`

Requiere: `agents` · `sessions` · `sessionPersistence` · `subagents`
...
Fuente: [`packages/experimental/agent-team/src/types.ts:125`](../packages/experimental/agent-team/src/types.ts)

<a id="deepseek-aidsh-experimental-tool-agent-team"></a>

## `@deepseek-ai/dsh-experimental-tool-agent-team`

Requiere: `agents` · `agentTeams` · `tools` · `systemPrompt`
...
Fuente: [`packages/experimental/tool-agent-team/src/index.ts:17`](../packages/experimental/tool-agent-team/src/index.ts)
...
Fuente: [`packages/context/file-reference-local/src/index.ts:35`](../packages/context/file-reference-local/src/index.ts)
...
Fuente: [`packages/fs/fs-local/src/index.ts:41`](../packages/fs/fs-local/src/index.ts)

<a id="deepseek-aidsh-fs-sandbox"></a>

## `@deepseek-ai/dsh-fs-sandbox`

Requiere: `sandboxPolicy`
...
Depende de: [`LocalConfig`](#deepseek-aidsh-fs-local)

Fuente: [`packages/fs/fs-sandbox/src/index.ts:49`](../packages/fs/fs-sandbox/src/index.ts)
...
Fuente: [`packages/goal/goal/src/index.ts:116`](../packages/goal/goal/src/index.ts)

<a id="deepseek-aidsh-headless"></a>

## `@deepseek-ai/dsh-headless`

Requiere: `agentDefaultModel` · `agents` · `sessions`
...
Fuente: [`packages/bundle/headless/src/index.ts:31`](../packages/bundle/headless/src/index.ts)
...
Fuente: [`packages/hooks/hooks-claude-code/src/index.ts:45`](../packages/hooks/hooks-claude-code/src/index.ts)
...
Fuente: [`packages/hooks/hooks-codex/src/index.ts:44`](../packages/hooks/hooks-codex/src/index.ts)

<a id="deepseek-aidsh-host-apiproxy"></a>

## `@deepseek-ai/dsh-host-apiproxy`

Requiere: `agentDefaultModel` · `agents` · `attachments` · `directoryPicker` · `llm` · `sessions` · `subagents` · `sessionQuery` · `tools` · `userQuestions` · `workspaceRegistry`
...
Fuente: [`packages/host/apiproxy/src/index.ts:41`](../packages/host/apiproxy/src/index.ts)
...
Fuente: [`packages/host/directory-picker-browse/src/index.ts:181`](../packages/host/directory-picker-browse/src/index.ts)
...
Fuente: [`packages/host/frontend-static/src/index.ts:28`](../packages/host/frontend-static/src/index.ts)
...
Fuente: [`packages/host/webserver/src/index.ts:59`](../packages/host/webserver/src/index.ts)
...
Fuente: [`packages/runtime-diagnostics/invariants/src/index.ts:15`](../packages/runtime-diagnostics/invariants/src/index.ts)
...
Fuente: [`packages/jobs/jobs-local/src/index.ts:31`](../packages/jobs/jobs-local/src/index.ts)
...
Depende de: [`ModelModality`](../packages/llm/llm/src/index.ts) · [`RetryPolicyConfig`](../packages/llm/llm/src/index.ts)

Fuente: [`packages/llm/llm-deepseek/src/index.ts:106`](../packages/llm/llm-deepseek/src/index.ts)
...
Depende de: `Api` (`@earendil-works/pi-ai`) · `CacheRetention` (`@earendil-works/pi-ai`) · `Model` (`@earendil-works/pi-ai`) · `ModelThinkingLevel` (`@earendil-works/pi-ai`) · `OpenAICompletionsCompat` (`@earendil-works/pi-ai`) · [`RetryPolicyConfig`](../packages/llm/llm/src/index.ts) · `ThinkingBudgets` (`@earendil-works/pi-ai`) · `Transport` (`@earendil-works/pi-ai`)

Fuente: [`packages/llm/llm-pi-ai/src/config.ts:213`](../packages/llm/llm-pi-ai/src/config.ts)
...
Fuente: [`packages/test-support/llm-replay/src/index.ts:809`](../packages/test-support/llm-replay/src/index.ts)
...
Fuente: [`packages/llm/llm-retry/src/index.ts:24`](../packages/llm/llm-retry/src/index.ts)

<a id="deepseek-aidsh-lsp-stdio"></a>

## `@deepseek-ai/dsh-lsp-stdio`

Requiere: `fs` · `lsp` · `subprocess`
...
Fuente: [`packages/lsp/lsp-stdio/src/index.ts:82`](../packages/lsp/lsp-stdio/src/index.ts)
...
Fuente: [`packages/mcp/mcp-client/src/index.ts:98`](../packages/mcp/mcp-client/src/index.ts)

<a id="deepseek-aidsh-message-feedback"></a>

## `@deepseek-ai/dsh-message-feedback`

Requiere: `storageDomain` · `sessionPersistence` · `sessions`
...
Fuente: [`packages/feedback/message-feedback/src/index.ts:49`](../packages/feedback/message-feedback/src/index.ts)

<a id="deepseek-aidsh-permission-presets"></a>

## `@deepseek-ai/dsh-permission-presets`

Requiere: `shell` · `approval` · `sessions`
...
Depende de: [`ApprovalPolicy`](subsystems/approval.es.md) · [`SandboxMode`](subsystems/sandbox.es.md)

Fuente: [`packages/interaction/permission-presets/src/index.ts:156`](../packages/interaction/permission-presets/src/index.ts)

<a id="deepseek-aidsh-persona"></a>

## `@deepseek-ai/dsh-persona`

Requiere: `systemPrompt`
...
Fuente: [`packages/preset/persona/src/index.ts:34`](../packages/preset/persona/src/index.ts)

<a id="deepseek-aidsh-plan-mode"></a>

## `@deepseek-ai/dsh-plan-mode`

Requiere: `tools` · `systemPrompt`
...
Fuente: [`packages/plan/plan-mode/src/index.ts:70`](../packages/plan/plan-mode/src/index.ts)
...
Fuente: [`packages/shell/pwsh-local/src/index.ts:58`](../packages/shell/pwsh-local/src/index.ts)
...
Depende de: [`LocalConfig`](#deepseek-aidsh-pwsh-local)

Fuente: [`packages/shell/pwsh-sandbox/src/index.ts:40`](../packages/shell/pwsh-sandbox/src/index.ts)
...
Fuente: [`packages/guard/repeat-tool-reminder/src/index.ts:28`](../packages/guard/repeat-tool-reminder/src/index.ts)
...
Fuente: [`packages/sandbox/sandbox-local/src/index.ts:44`](../packages/sandbox/sandbox-local/src/index.ts)
...
Depende de: [`SandboxMode`](subsystems/sandbox.es.md)

Fuente: [`packages/sandbox/sandbox-policy/src/index.ts:67`](../packages/sandbox/sandbox-policy/src/index.ts)
...
Depende de: `Readable` (`node:stream`) · `Writable` (`node:stream`)

Fuente: [`packages/sdk/server/src/index.ts:25`](../packages/sdk/server/src/index.ts)
...
Fuente: [`packages/session/session-persistence-jsonl/src/index.ts:60`](../packages/session/session-persistence-jsonl/src/index.ts)
...
Fuente: [`packages/session/session-persistence-sqlite/src/index.ts:36`](../packages/session/session-persistence-sqlite/src/index.ts)

<a id="deepseek-aidsh-session-projection-cache"></a>

## `@deepseek-ai/dsh-session-projection-cache`

Requiere: `storageDomain` · `sessionProjections` · `sessionPersistence` · `sessions`
...
Fuente: [`packages/session/session-projection-cache/src/index.ts:42`](../packages/session/session-projection-cache/src/index.ts)
...
Depende de: [`SessionQueryConfig`](../packages/session-query/session-query/src/index.ts)

Fuente: [`packages/session-query/session-query-sqlite/src/index.ts:89`](../packages/session-query/session-query-sqlite/src/index.ts)

<a id="deepseek-aidsh-session-reference"></a>

## `@deepseek-ai/dsh-session-reference`

Requiere: `sessionQuery`
...
Fuente: [`packages/context/session-reference/src/config.ts:11`](../packages/context/session-reference/src/config.ts)
...
Depende de: `BatchLogRecordProcessorOptions` (`@opentelemetry/sdk-logs`) · `OTLPExporterNodeConfigBase` (`@opentelemetry/otlp-exporter-base`)

Fuente: [`packages/session/session-telemetry-otel/src/index.ts:91`](../packages/session/session-telemetry-otel/src/index.ts)
...
Fuente: [`packages/session/session-title/src/index.ts:79`](../packages/session/session-title/src/index.ts)

<a id="deepseek-aidsh-session-title-all-prompts-llm"></a>

## `@deepseek-ai/dsh-session-title-all-prompts-llm`

Requiere: `sessionTitle` · `llm` · `sessions`
...
Depende de: [`SessionTitleLlmConfig`](../packages/session/session-title-llm/src/index.ts)

Fuente: [`packages/session/session-title-all-prompts-llm/src/index.ts:15`](../packages/session/session-title-all-prompts-llm/src/index.ts)
...
Fuente: [`packages/session/session-title-first-prompt-llm/src/index.ts:15`](../packages/session/session-title-first-prompt-llm/src/index.ts)
...
Fuente: [`packages/settings/settings-file/src/index.ts:21`](../packages/settings/settings-file/src/index.ts)
...
Fuente: [`packages/shell/shell-env/src/index.ts:29`](../packages/shell/shell-env/src/index.ts)
...
Fuente: [`packages/skill/skill/src/index.ts:279`](../packages/skill/skill/src/index.ts)
...
Fuente: [`packages/skill/skill-filesystem/src/index.ts:49`](../packages/skill/skill-filesystem/src/index.ts)
...
Fuente: [`packages/spill/spill-local/src/index.ts:22`](../packages/spill/spill-local/src/index.ts)
...
Fuente: [`packages/spill/spill-policy/src/index.ts:60`](../packages/spill/spill-policy/src/index.ts)
...
Fuente: [`packages/storage/storage-domain/src/index.ts:52`](../packages/storage/storage-domain/src/index.ts)
...
Fuente: [`packages/storage/storage-json/src/index.ts:27`](../packages/storage/storage-json/src/index.ts)
...
Fuente: [`packages/storage/storage-sqlite/src/index.ts:24`](../packages/storage/storage-sqlite/src/index.ts)

<a id="deepseek-aidsh-subagent-acp"></a>

## `@deepseek-ai/dsh-subagent-acp`

Requiere: `subagents` · `subprocess`
...
Fuente: [`packages/subagent/subagent-acp/src/index.ts:27`](../packages/subagent/subagent-acp/src/index.ts)
...
Fuente: [`packages/subagent/subagent-claude-code/src/index.ts:38`](../packages/subagent/subagent-claude-code/src/index.ts)
...
Fuente: [`packages/subagent/subagent-codex/src/index.ts:36`](../packages/subagent/subagent-codex/src/index.ts)
...
Fuente: [`packages/subagent/subagent-dsh-sdk/src/index.ts:29`](../packages/subagent/subagent-dsh-sdk/src/index.ts)
...
Fuente: [`packages/subagent/subagent-fork-in-process/src/index.ts:31`](../packages/subagent/subagent-fork-in-process/src/index.ts)
...
Fuente: [`packages/subagent/subagent-spawn-in-process/src/index.ts:25`](../packages/subagent/subagent-spawn-in-process/src/index.ts)
...
Fuente: [`packages/e2b/subprocess-e2b/src/index.ts:25`](../packages/e2b/subprocess-e2b/src/index.ts)
...
Fuente: [`packages/core/system-prompt/src/index.ts:186`](../packages/core/system-prompt/src/index.ts)

<a id="deepseek-aidsh-terminal-bash"></a>

## `@deepseek-ai/dsh-terminal-bash`

Requiere: `terminals` · `sandboxPolicy` · `subprocess`
...
Fuente: [`packages/terminal/terminal-bash/src/config.ts:10`](../packages/terminal/terminal-bash/src/config.ts)
...
Fuente: [`packages/context/time-context/src/index.ts:27`](../packages/context/time-context/src/index.ts)
...
Fuente: [`packages/context/tmux-context/src/index.ts:34`](../packages/context/tmux-context/src/index.ts)
...
Fuente: [`packages/llm/token-meter/src/types.ts:12`](../packages/llm/token-meter/src/types.ts)

<a id="deepseek-aidsh-tool-bash"></a>

## `@deepseek-ai/dsh-tool-bash`

Requiere: `tools` · `shell` · `systemPrompt` · `shellEnv`
...
Fuente: [`packages/shell/tool-bash/src/index.ts:34`](../packages/shell/tool-bash/src/index.ts)

<a id="deepseek-aidsh-tool-bash-persistent"></a>

## `@deepseek-ai/dsh-tool-bash-persistent`

Requiere: `tools` · `terminals`
...
Fuente: [`packages/shell/tool-bash-persistent/src/index.ts:432`](../packages/shell/tool-bash-persistent/src/index.ts)

<a id="deepseek-aidsh-tool-fs"></a>

## `@deepseek-ai/dsh-tool-fs`

Requiere: `tools` · `fs` · `systemPrompt`
...
Fuente: [`packages/fs/tool-fs/src/index.ts:25`](../packages/fs/tool-fs/src/index.ts)

<a id="deepseek-aidsh-tool-fs-search"></a>

## `@deepseek-ai/dsh-tool-fs-search`

Requiere: `tools` · `systemPrompt` · `subprocess`
...
Fuente: [`packages/fs/tool-fs-search/src/index.ts:73`](../packages/fs/tool-fs-search/src/index.ts)

<a id="deepseek-aidsh-tool-goal"></a>

## `@deepseek-ai/dsh-tool-goal`

Requiere: `agents` · `goals` · `tools` · `systemPrompt`
...
Fuente: [`packages/goal/tool-goal/src/index.ts:26`](../packages/goal/tool-goal/src/index.ts)

<a id="deepseek-aidsh-tool-jobs"></a>

## `@deepseek-ai/dsh-tool-jobs`

Requiere: `tools` · `jobs` · `systemPrompt`
...
Fuente: [`packages/jobs/tool-jobs/src/index.ts:32`](../packages/jobs/tool-jobs/src/index.ts)

<a id="deepseek-aidsh-tool-lsp"></a>

## `@deepseek-ai/dsh-tool-lsp`

Requiere: `tools` · `lsp` · `systemPrompt`
...
Fuente: [`packages/lsp/tool-lsp/src/index.ts:58`](../packages/lsp/tool-lsp/src/index.ts)
...
Fuente: [`packages/shell/tool-pwsh/src/index.ts:52`](../packages/shell/tool-pwsh/src/index.ts)
...
Fuente: [`packages/shell/tool-pwsh-persistent/src/index.ts:472`](../packages/shell/tool-pwsh-persistent/src/index.ts)

<a id="deepseek-aidsh-tool-ralph"></a>

## `@deepseek-ai/dsh-tool-ralph`

Requiere: `tools` · `workflowEngine` · `subagents` · `systemPrompt`
...
Fuente: [`packages/workflow/tool-ralph/src/index.ts:23`](../packages/workflow/tool-ralph/src/index.ts)

<a id="deepseek-aidsh-tool-session-query"></a>

## `@deepseek-ai/dsh-tool-session-query`

Requiere: `tools` · `systemPrompt` · `sessionQuery`
...
Fuente: [`packages/session-query/tool-session-query/src/index.ts:29`](../packages/session-query/tool-session-query/src/index.ts)

<a id="deepseek-aidsh-tool-skill"></a>

## `@deepseek-ai/dsh-tool-skill`

Requiere: `agents` · `tools` · `skills`
...
Fuente: [`packages/skill/tool-skill/src/index.ts:61`](../packages/skill/tool-skill/src/index.ts)
...
Fuente: [`packages/fs/tool-str-replace-editor/src/index.ts:497`](../packages/fs/tool-str-replace-editor/src/index.ts)

<a id="deepseek-aidsh-tool-subagent"></a>

## `@deepseek-ai/dsh-tool-subagent`

Requiere: `tools` · `subagents` · `systemPrompt`
...
Depende de: [`AgentOptions`](subsystems/core.es.md)

Fuente: [`packages/subagent/tool-subagent/src/index.ts:29`](../packages/subagent/tool-subagent/src/index.ts)

<a id="deepseek-aidsh-tool-subagent-report"></a>

## `@deepseek-ai/dsh-tool-subagent-report`

Requiere: `subagents` · `tools` · `systemPrompt`
...
Depende de: [`SubagentReportDelivery`](subsystems/subagent.es.md)

Fuente: [`packages/subagent/tool-subagent-report/src/index.ts:27`](../packages/subagent/tool-subagent-report/src/index.ts)

<a id="deepseek-aidsh-tool-terminal"></a>

## `@deepseek-ai/dsh-tool-terminal`

Requiere: `terminals` · `tools` · `systemPrompt`
...
Fuente: [`packages/terminal/tool-terminal/src/index.ts:35`](../packages/terminal/tool-terminal/src/index.ts)
...
Fuente: [`packages/todo/tool-todo/src/index.ts:29`](../packages/todo/tool-todo/src/index.ts)

<a id="deepseek-aidsh-tool-web"></a>

## `@deepseek-ai/dsh-tool-web`

Requiere: `tools` · `web` · `systemPrompt`
...
Fuente: [`packages/web/tool-web/src/index.ts:37`](../packages/web/tool-web/src/index.ts)

<a id="deepseek-aidsh-tool-workflow"></a>

## `@deepseek-ai/dsh-tool-workflow`

Requiere: `tools` · `workflowEngine` · `systemPrompt`
...
Fuente: [`packages/workflow/tool-workflow/src/index.ts:33`](../packages/workflow/tool-workflow/src/index.ts)
...
Fuente: [`packages/core/tools/src/index.ts:654`](../packages/core/tools/src/index.ts)

<a id="deepseek-aidsh-typert-loader"></a>

## `@deepseek-ai/dsh-typert-loader`

Requiere: `typert` · `loader`
...
Fuente: [`packages/typert/loader/src/index.ts:47`](../packages/typert/loader/src/index.ts)
...
Fuente: [`packages/interaction/user-approval/src/index.ts:177`](../packages/interaction/user-approval/src/index.ts)
...
Fuente: [`packages/web/web/src/index.ts:55`](../packages/web/web/src/index.ts)
...
Fuente: [`packages/bundle/web-app/src/index.ts:42`](../packages/bundle/web-app/src/index.ts)
...
Fuente: [`packages/web/web-fetch-http/src/index.ts:34`](../packages/web/web-fetch-http/src/index.ts)
...
Fuente: [`packages/web/web-search-deepseek/src/index.ts:46`](../packages/web/web-search-deepseek/src/index.ts)
...
Fuente: [`packages/web/web-search-exa/src/index.ts:38`](../packages/web/web-search-exa/src/index.ts)
...
Fuente: [`packages/web/web-search-perplexity/src/index.ts:32`](../packages/web/web-search-perplexity/src/index.ts)
...
Fuente: [`packages/workflow/workflow-worker-thread/src/index.ts:32`](../packages/workflow/workflow-worker-thread/src/index.ts)

## Plugins cargables sin configuración

Estos cargan desde una entrada de `cordis.yml` sin bloque `config:`; no declaran ninguna API de configuración.
...
## Paquetes seam (no cargables directamente)

Clases de servicio abstractas: un despliegue carga en su lugar un paquete de implementación concreta ([seams de capacidad](../.agents/notes/implemented/architecture/2026-06-13-capability-seams.md)).
...
## Paquetes de biblioteca (sin entrada de plugin)

Se importan como bibliotecas desde otros paquetes; un `cordis.yml` no puede cargarlos.
