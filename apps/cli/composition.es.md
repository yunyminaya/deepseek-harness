...
# Composición base de DSH

[English](composition.md) | Español

El bundle dsh-base es el parche que todo perfil aplica en primer lugar; los bundles de modo (dsh-web-app, dsh-headless) y la capa del perfil del usuario se aplican por encima de él.
...
Configuración de origen: [`packages/bundle/base/cordis.patch.yml`](../../packages/bundle/base/cordis.patch.yml).

Modo de mantenimiento: híbrido: la lista de plugins hoja se extrae de su `cordis.yml`; la expansión de paquetes de la aplicación se cura a partir del código fuente de los paquetes.
